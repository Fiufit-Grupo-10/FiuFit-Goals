...
def test_create_goals(test_app):
    goals = [{"training_type": "Cardio", "amount": 100, "goal_type": "calories"}]
...
def test_create_goals_with_incorrect_type(test_app):
    goals = [{"training_type": "Cardio", "amount": 100, "goal_type": "running"}]
...
async def test_update_goals(test_app):
    goals = [
        {"training_type": "Cardio", "amount": 100, "goal_type": "calories"},
        {"training_type": "Fuerza", "amount": 1000, "goal_type": "calories"},
    ]
    ...
    updated_goals = [
        {"training_type": "steps", "amount": 5000, "goal_type": "steps"},
    ]
